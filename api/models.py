...
class Titles(models.Model):
    category = models.ManyToManyField(Category, blank=True, related_name="titles_category")
    genre = models.ManyToManyField(Genre, blank=True, related_name="titles_genre")
